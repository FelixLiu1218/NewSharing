...
namespace NewProject
{
    ...
    public class SettingsViewModel : BaseViewModel
    {
        ...
        public async Task Logout()
        {
            ...
            await ClientDataStore.ClearAllLoginCredentials();
        ...
        public async Task Load()
        {
            ...
            await RunCommandAsync(() => SettingsLoading, async () =>
            {
                ...
                await UpdateValuesFromLocalStore(scopedClientDataStore);

                // Get the user token
                var token = (await scopedClientDataStore.GetLoginCredentials())?.Token;
                ...
                await scopedClientDataStore.SaveLoginCredentials(dataModel);
        ...
        public async Task<bool> SaveFirstNameAsync()
        {
            ...
            return await RunCommandAsync(() => FirstNameIsSaving, async () =>
            {
                ...
                return await UpdateUserCredentialsValue(
                    // Display name
                    "First Name",
        ...
        public async Task<bool> SavePasswordAsync()
        {
            ...
            return await RunCommandAsync(() => PasswordIsChanging, async () =>
            {
                ...
                var credentials = await ClientDataStore.GetLoginCredentials();

                // Make sure the user has entered the same password
                if (Password.EditedPassword.Unsecure() != Password.ConfirmPassword.Unsecure())
                {
                    // Display error
                ...
                var result = await WebRequests.PostAsync<ApiResponse>(
                    ...
                    {
                        CurrentPassword = Password.OriginalPassword.Unsecure(),
                        NewPassword = Password.EditedPassword.Unsecure()
                    },
                    // Pass in user Token
        ...
        /// </summary>
        /// <returns></returns>
        private async Task UpdateValuesFromLocalStore(IClientDataStore clientDataStore)
        {
            // Get the stored credentials
            var storedCredentials = await clientDataStore.GetLoginCredentials();
        ...
        /// <returns></returns>
        private async Task<bool> UpdateUserCredentialsValue(string displayName, Expression<Func<LoginCredentialsDataModel, string>> propertyToUpdate, string newValue, Action<UpdateUserProfileApiModel, string> setApiModel)
        {
            // Log it
            ...
            await ClientDataStore.SaveLoginCredentials(credentials);
